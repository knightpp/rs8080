...
pub fn disassemble(bytes: &[u8]) -> Command {
    ...
    let mut command: Command = match *bytes {
        ...
        [0x0E, d8, ..] => (Cmd::MVI, (C), D8(d8).into(), 2).into(),
        [0x0F, ..] => (Cmd::RRC, 1).into(),

        [0x10, ..] => (Cmd::NOPU, 1).into(),
        [0x11, d16_lo, d16_hi, ..] => (Cmd::LXI, (D), D16(d16_lo, d16_hi).into(), 3).into(),
        [0x12, ..] => (Cmd::STAX, D, 1).into(),
        [0x13, ..] => (Cmd::INX, D, 1).into(),
        [0x14, ..] => (Cmd::INR, D, 1).into(),
        [0x15, ..] => (Cmd::DCR, D, 1).into(),
        [0x16, d8, ..] => (Cmd::MVI, (D), D8(d8).into(), 2).into(),
        [0x17, ..] => (Cmd::RAL, 1).into(),
        ...
        [0x1E, d8, ..] => (Cmd::MVI, (E), D8(d8).into(), 2).into(),
        [0x1F, ..] => (Cmd::RAR, 1).into(),
        ...
        [0x26, d8, ..] => (Cmd::MVI, (H), D8(d8).into(), 2).into(),
        [0x27, ..] => (Cmd::DAA, 1).into(),
